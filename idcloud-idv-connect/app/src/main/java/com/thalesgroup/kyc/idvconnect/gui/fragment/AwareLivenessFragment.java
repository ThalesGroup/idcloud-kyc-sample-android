...
import com.thalesgroup.kyc.idvconnect.gui.view.AwareLivenessFeedbackView;
...
public class AwareLivenessFragment extends Fragment implements WorkflowStateCallback {
     ...
     * {@link com.aware.face_liveness.api.interfaces.WorkflowStateCallback.WorkflowState#COMPLETE }
    ...
    public void reportFeedback(com.aware.face_liveness.api.FaceLiveness.AutoFeedback feedback ) {
        if (!this.isVisible())
            return;
    ...
    private String getAutoCaptureString(com.aware.face_liveness.api.FaceLiveness.AutoFeedback code) {
        String result = "";
        switch (code) {
            case OFF:
